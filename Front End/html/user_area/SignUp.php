            ...
            <section class="signup-section">
                ...
                <form method="post" enctype="multipart/form-data" class="signup_container" id="signup_form">
                    ...
                    <div class="item">
                        ...
                        <input type="text" name="username" autofocus="" autocapitalize="none" required id="id_username" placeholder="First and Last">
                    </div>
                    ...
                    <div class="item">
                        ...
                        <input type="file" id="user_image" name="user_image" requried>
                    </div>
                    ...
                    <div class="item">
                        ...
                        <input type="text" name="address_street" autofocus="" autocapitalize="none" required id="id_address" placeholder="Area or Street">
                    </div>

                    <div class="item">
                        <label for="address_town">City/District/Town</label>
                        <input type="text" name="address_town" autofocus="" autocapitalize="none" required id="id_address">
                    </div>

                    <div class="item">
                        <label for="address_state">State</label>
                        <input type="text" name="address_state" autofocus="" autocapitalize="none" required id="id_address">
                    </div>

                    <div class="item">
                        <label for="address_landmark">Landmark <i>(Optional)</i></label>
                        <input type="text" name="address_landmark" autofocus="" autocapitalize="none" id="id_address">
                    </div>

                    <!-- Zipcode -->
                    <div class="item">
                        <label for="zipcode">Zipcode</label>
                        <input type="text" name="zipcode" autofocus="" autocapitalize="none" required id="id_zipcode">
                    </div>
